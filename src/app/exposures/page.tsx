  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      <div className="container mx-auto px-8 py-8 max-w-7xl">
        <div className="mb-8">
          <Link href="/categories" className="inline-flex items-center text-gray-600 hover:text-gray-900 mb-4 transition-colors">
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div>
              {filteredChemicals.map((chemical, index) => {
                ...
                return (
                  <div key={index}>
                    <div className={`px-6 py-3.5 transition-all duration-200 ${
                      ...
                      <div className="grid grid-cols-12 gap-4 items-center">
                        <div className="col-span-3">
                          <Link 
                            ...
                            className="text-sm font-semibold text-gray-900 hover:text-[#1a2540] truncate block transition-colors"
                          >
                            {chemical.compound}
                          </Link>
                        </div>
                        <div className="col-span-2">
                          <Link
                            ...
                            className="text-sm text-[#1a2540] hover:text-[#1a2540]/80 hover:underline truncate block transition-colors"
                          >
