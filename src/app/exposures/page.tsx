      ...
      <div className="container mx-auto px-4 lg:px-8 py-8 max-w-7xl">
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row items-start lg:items-start justify-between mb-6 gap-4">
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2 flex items-center gap-2 lg:gap-3">
              ...
              <p className="text-sm lg:text-base text-gray-600">Viewing all chemicals across all categories</p>
              <p className="text-xs lg:text-sm text-gray-500 mt-1">
                <span className="text-[#9CBB04] font-semibold">Detected {detectedCount}/{totalCount}</span> exposures
              </p>
            </div>
            <div className="bg-gradient-to-br from-[#9CBB04]/10 to-[#9CBB04]/20 border border-[#9CBB04]/30 px-3 lg:px-4 py-2 rounded-lg shadow-sm">
              <span className="text-xs lg:text-sm font-medium text-[#9CBB04]">
                          ...
                          <div className="grid grid-cols-12 gap-2 lg:gap-4 items-center">
                            ...
                            <div className="col-span-2">
                              <Link
                                ...
                                onClick={(e) => e.stopPropagation()}
                                className="text-xs lg:text-sm text-[#9CBB04] hover:text-[#9CBB04] hover:underline truncate block transition-colors font-medium"
                              >
