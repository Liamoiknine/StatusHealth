              ...
              {viewMode === 'chemicals' && (
                <div className="mb-8">
                  ...
                  <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                    <div className="px-6 py-4 bg-white border-b-4 border-[#9CBB04]">
                          ...
                          <div key={index}>
                            ...
                            {isExpanded && (
                              ...
                              >
                                ...
                                <div className="inline-flex items-center text-[#404B69] hover:text-[#404B69]/80 transition-colors text-sm font-medium">
                                  View Full Page
