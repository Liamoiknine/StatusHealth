  ...
  return (
    <aside className={`${isCollapsed ? 'w-16' : 'w-72'} bg-[#1a2540] min-h-screen border-r border-gray-800 flex flex-col transition-all duration-300 relative`}>
      ...
      <nav className={`${isCollapsed ? 'px-2' : 'px-4'} pt-10 pb-2`}>
        {/* Dashboard */}
        <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'space-x-3'} px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-gray-800 transition-colors`} title={isCollapsed ? 'Dashboard' : ''}>
