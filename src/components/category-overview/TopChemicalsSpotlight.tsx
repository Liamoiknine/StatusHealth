  ...
  if (topChemicals.length === 0) {
    return (
      <div className="bg-[#1a2540] border border-gray-700 rounded-lg p-6">
        ...
        <p className="text-gray-400 text-center py-8">No detected chemicals in this category</p>
      </div>
    );
  }
          ...
          return (
            ...
            >
              <Link
                ...
                className="block bg-[#0f1729] border border-gray-800 rounded-lg p-4 hover:border-teal-500/50 transition-all duration-300"
              >
                ...
                <div className="mt-3 flex items-center text-teal-400 text-xs">
